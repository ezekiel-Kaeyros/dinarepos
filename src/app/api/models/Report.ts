...
const ReportSchema = new Schema<reportType>({
  ...
  identityOption: { type: String, required: true },
  employeesNumbOption: { type: String, required: false },
  ageOption: { type: String, required: false },
  singleDate: { type: String, required: true },
